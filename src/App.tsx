    ...
    <div className="App">
      ...
      <div className="flex-column">
        ...
        <div className="px-2 py-4 w-full flex">
                ...
                <button id="dropdownDefault" data-dropdown-toggle="dropdown" type="button" className="flex-1 text-left cursor-pointer py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-whiteColor focus:outline-none rounded-lg focus:z-10 focus:ring-4 dark:focus:ring-gray-700 dark:bg-gray-800 ml-2">Axie Infinity</button>
      ...
      <div id="dropdown">
        <ul aria-labelledby="dropdownDefault">
          <li>{<GuildCard image={image} name="AAP MAX SPEED" scholar="50%" applicants={232} guild="50%" days={2} expire={9} new_applicants={16}/>}</li>
          <li>{<GuildCard image={image} name="AAP MAX SPEED" scholar="50%" applicants={232} guild="50%" days={2} expire={9} />}</li>
          <li>{<GuildCard image={image} name="AAP MAX SPEED" scholar="50%" applicants={232} guild="50%" days={2} expire={9} />}</li>
        </ul>
