...
export const Individual = ({name,new_applicant,location,discord,tweeter,image,guild,top_game, mmr, win_rate}: Props) => {
  return (
      <div className=" max-w-full w-max overflow-visible">
          <div className=" rounded-xl  shadow-lg transition-all duration-200 ease-out transform hover:scale-105 cursor-pointer bg-lightGrayColor mt-1 mx-5 border border-nameColor h-full w-full place-items-center">
                ...
                <div className="px-2 py-4 w-full justify-between">
                    <div className="flex">
                        ...
                        <div className="border border-nameColor rounded-xl flex bg-gradient-to-r from-lightYellowColor to-cardBackground ">
                            <button className="flex-1 text-left cursor-pointer py-2.5 px-5 mr-2  text-sm font-medium text-whiteColor focus:outline-none rounded-lg ">Show profile</button>
                        </div>
                    ...
                    <p className=" text-base text-whiteColor ">{location}</p>
                    <div className="w-4/5 pt-2">
                        <p className=" text-base text-whiteColor">I am cool but not the coolest man you’ve seen before, cool as cool so cool the sun freezes in the midst of my presence cool</p>
                    </div>
                    
                        <div className=" flex justify-even basis-1/2 items-center">
                        ...
                        <div className="flex-1 flex justify-between w-full items-center">
                            <div className="px-2 flex flex-1 items-center border border-nameColor rounded-xl mr-3">
                                ...
                                <p className="flex-1 text-base text-whiteColor">Guild: <br />{guild}</p>
                            ...
                            <div className="px-2 flex flex-1 items-center border border-nameColor rounded-xl">
                                ...
                                <p className=" flex-1 text-base text-whiteColor">Top game: <br /> {top_game}</p>
            ...
            <div className="font-bold text-2xl mb-2 text-white flex flex-1  mx-20">EXPERIENCE</div>
                <div className="bg-backgroundColor mx-20 my-5 rounded-xl">
                    <div className="flex">
                        ...
                        <div className="px-2 py-4 w-full justify-between">
                            <div className="flex">
                                <div className="font-bold text-2xl mb-2 text-nameColor flex flex-1">AXIE INFINITY</div>
                            ...
                            <div className="px-2 w-full">
                                <div className="flex justify-between w-2/3 items-center">
                                    <p className=" text-base text-whiteColor">{guild}</p>
                                    <p className=" text-xl text-whiteColor">•</p>
                                    <p className=" text-base text-whiteColor">Highest MMR: {mmr}</p>
                                    <p className=" text-xl text-whiteColor">•</p>
                                    <p className=" text-base text-whiteColor">July 2021 - Sept 2021</p>
                                </div>
                                <div className="flex justify-between w-2/3 items-center">
                                    <p className=" text-base text-whiteColor">Was playing at YGG and then became a trainer due to my good performance</p>
                                    
                                </div>
                                <div className="flex-1 flex justify-between items-center">
                                    <img className="pl-5 py-5 w-1/3 h-1/3" src={exp1Img} />
                    ...
                    <div className="flex">
                        ...
                        <div className="px-2 py-4 w-full justify-between">
                        <div className="flex">
                            <div className="font-bold text-2xl mb-2 text-nameColor flex flex-1">ELPIS BATTLE</div>
                        ...
                        <div className="px-2 w-full">
                            <div className="flex justify-between w-2/3 items-center">
                                <p className=" text-base text-whiteColor">{guild}</p>
                                <p className=" text-xl text-whiteColor">•</p>
                                <p className=" text-base text-whiteColor">Win Rate: {win_rate}%</p>
                                <p className=" text-xl text-whiteColor">•</p>
                                <p className=" text-base text-whiteColor">July 2021 - Sept 2021</p>
                            </div>
                            <div className="flex justify-between w-2/3 items-center">
         ...
         <div className="bg-backgroundColor mx-20 my-5 rounded-xl">
                    <div className="flex">
                        ...
                        <div className="px-2 py-4 w-2/3 justify-between">
                            <div className="flex">
                                <div className="font-bold text-2xl mb-2 text-nameColor flex flex-1">GALAXY CUP 2021</div>
                            </div>

                            <div className="px-2 w-2/3">
                                <div className="flex justify-between w-ful items-center">
                                    <p className=" text-base text-whiteColor">AXIE INFINITY</p>
                                    <p className=" text-xl text-whiteColor">•</p>
                                    <p className=" text-base text-whiteColor">{guild}</p>
                                    <p className=" text-xl text-whiteColor">•</p>
                                    <p className=" text-base text-whiteColor">8th place</p>
                                     <p className=" text-xl text-whiteColor">•</p>
                                    <p className=" text-base text-whiteColor">21st June 2022</p>
                                </div>
                                <div className="flex justify-between w-full items-center">
                                    <p className=" text-base text-whiteColor">Finished the tournament in 8th place among other SEA players. Tournament badge shown here.</p>
