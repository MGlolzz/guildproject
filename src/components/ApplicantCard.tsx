...
export const ApplicantCard = ({name,guild,scholar,days,expire,applicants,new_applicants,image}: Props) => {
  return (
      <div className="max-w-full w-max">
          <div className=" rounded-xl overflow-hidden shadow-lg transition-all duration-200 ease-out transform hover:scale-105 cursor-pointer bg-cardBackground mt-5 mx-5 border border-nameColor h-full ">
            <div className="flex">
