  ...
  return (
      <div className="flex-column">
        ...
        <div className="max-w-md rounded-b-xl overflow-hidden shadow-lg transition-all duration-200 ease-out transform hover:scale-105 cursor-pointer flex bg-lightGrayColor mx-5 flex-1 hover:border-nameColor">
             <div id="dropdownRightButton2" data-dropdown-toggle="dropdownRight2" data-dropdown-placement="right" className="px-6 py-4 flex justify-between w-full">
        ...
        <div id="dropdownRight" className="flex-column hidden">
        ...
        <div id="dropdownRight2" className="flex-column hidden">
        ...
        <div id="dropdownRight3" className="flex-column hidden">
