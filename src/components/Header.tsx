...
export const Header =()=> {
  return (
      <div className="content-center pl-60  sticky top-0 z-20">

      
      <div className=" top-5 z-50 flex bg-gray-800 px-5 py-5 shadow-sm pb-7 border-4 border-nameColor rounded-lg w-4/5">
