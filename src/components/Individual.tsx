...
export const Individual = ({name,new_applicant,location,discord,tweeter,image,guild,top_game, mmr, win_rate}: Props) => {
  return (
      <div className=" max-w-full w-max">
          <div className=" rounded-xl overflow-hidden shadow-lg transition-all duration-200 ease-out transform hover:scale-105 cursor-pointer bg-lightGrayColor mt-1 mx-5 border border-nameColor h-full w-full place-items-center">
