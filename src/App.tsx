  ...
  return (
    <div className="App h-screen">
      ...
      <div className="z-10">
          ...
          <h1 className="font-bold text-4xl mb-1 text-nameColor text-opacity-20">SCHOLARSHIP LISTING</h1>
        ...
        <div className="flex-column">
            <div className="max-w-md rounded-xl shadow-lg transition-all duration-200 ease-out transform hover:scale-105 cursor-pointer flex bg-cardBackground mx-5">
